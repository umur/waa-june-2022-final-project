...
insert into Job_Application (students_id,job_applications_id) values (2,1);
insert into Job_Application (students_id,job_applications_id) values (8,1);
insert into Job_Application (students_id,job_applications_id) values (9,1);
insert into Job_Application (students_id,job_applications_id) values (10,1);
insert into Job_Application (students_id,job_applications_id) values (3,2);
insert into Job_Application (students_id,job_applications_id) values (5,2);
insert into Job_Application (students_id,job_applications_id) values (6,3);
insert into Job_Application (students_id,job_applications_id) values (10,4);
