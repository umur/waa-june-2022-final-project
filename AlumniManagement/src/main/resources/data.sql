...
INSERT INTO job_advertisement (add_benefit,company_name,job_desc,job_title,student_id,num_opening,payment_amount,id_address) VALUES ('good salary with bonus','Infosys','Mid level java developer needed in Infosys','java Developer',1,5,1231,1);
INSERT INTO job_advertisement (add_benefit,company_name,job_desc,job_title,student_id,num_opening,payment_amount,id_address) VALUES ('good salary with bonus','Data Sys','Top level developer needed ','.Net Developer',2,10,16516,2);
INSERT INTO job_advertisement (add_benefit,company_name,job_desc,job_title,student_id,num_opening,payment_amount,id_address) VALUES ('good salary with bonus','Cotivity','Mid level developer needed ','Backend Developer',1,5,1231,1);
INSERT INTO job_advertisement (add_benefit,company_name,job_desc,job_title,student_id,num_opening,payment_amount,id_address) VALUES ('good salary with bonus','F1','Mid level developer needed in Infosys','FrontEnd Developer',2,10,16516,2);
INSERT INTO job_advertisement (add_benefit,company_name,job_desc,job_title,student_id,num_opening,payment_amount,id_address) VALUES ('good salary with bonus','Javra','developer needed','java Developer',1,5,1231,1);
INSERT INTO job_advertisement (add_benefit,company_name,job_desc,job_title,student_id,num_opening,payment_amount,id_address) VALUES ('good salary with bonus','Data One','Mid level developer needed in Infosys','.Net Developer',2,10,16516,2);
INSERT INTO job_advertisement (add_benefit,company_name,job_desc,job_title,student_id,num_opening,payment_amount,id_address) VALUES ('good salary with bonus','Infosys Two','Mid level java developer needed in Infosys','MongoDb Developer',1,5,1231,1);
INSERT INTO job_advertisement (add_benefit,company_name,job_desc,job_title,student_id,num_opening,payment_amount,id_address) VALUES ('good salary with bonus','Data Sys Mgmt','Mid level developer needed in Infosys','Spring Developer',2,10,16516,2);
INSERT INTO job_advertisement (add_benefit,company_name,job_desc,job_title,student_id,num_opening,payment_amount,id_address) VALUES ('good salary with bonus','Infosys Dev','Mid level java developer needed in Infosys','java Developer',1,5,1231,1);
INSERT INTO job_advertisement (add_benefit,company_name,job_desc,job_title,student_id,num_opening,payment_amount,id_address) VALUES ('good salary with bonus','Data Sys INfo','Mid level developer needed in Infosys','.Net Developer',2,10,16516,2);
INSERT INTO job_advertisement (add_benefit,company_name,job_desc,job_title,student_id,num_opening,payment_amount,id_address) VALUES ('good salary with bonus',' INfo','Top level developer needed in Infosys','.Net Developer',2,10,16516,2);
